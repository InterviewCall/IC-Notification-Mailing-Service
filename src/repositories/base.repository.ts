import { CreationAttributes, InferAttributes, Model, ModelStatic, Transaction, WhereOptions } from 'sequelize';
...
abstract class BaseRepository<M extends Model> {
    ...
    async findOne(whereOptions: WhereOptions<InferAttributes<M>>, transaction?: Transaction): Promise<M | null> {
